...
enum PredefinedDictionaryType {
    ...
    DICT_4X4_50_RATIO,      ///< same markers as DICT_4X4_50, stored with DICT_ENCODING_CELL_RATIO encoding, 50 codes
    DICT_5X5_50_RATIO,      ///< same markers as DICT_5X5_50, stored with DICT_ENCODING_CELL_RATIO encoding, 50 codes
    DICT_6X6_50_RATIO,      ///< same markers as DICT_6X6_50, stored with DICT_ENCODING_CELL_RATIO encoding, 50 codes
    DICT_7X7_50_RATIO       ///< same markers as DICT_7X7_50, stored with DICT_ENCODING_CELL_RATIO encoding, 50 codes
};
